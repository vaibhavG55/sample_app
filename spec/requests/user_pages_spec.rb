...
describe "UserPages" do
  ...
  describe "following/follower user" do
    ...
    let!(:m2){FactoryGirl.create(:micropost,user: user,content: "Bar")}
     ...
     describe "follow/unfollow button" do
        ...
        describe "following a user" do
           ...
           it "should increment user's followed user count" do
             expect{click_button "Follow"}.to change(user.followed_users, :count).by(1)
           end
           
           it "should increase other users following users" do
        ...
        describe "unfollowing a user" do
           ...
           it "should decrease user's followed user" do
              expect{click_button "Unfollow"}.to change(user.followed_users, :count).by(-1)
           end
           
           it "should decrease other user's following user" do
